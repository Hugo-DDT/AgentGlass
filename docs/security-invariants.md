...
| N-002 | INV-002/003/005/007～010/012/013/016/019/020：结构事实生成建议、未知/多原因不降级、不重放原批次、可能已执行不重试、目标身份与生命周期、无旧结果覆盖 | LOCAL_PASS_PENDING_REMOTE_RECHECK（references §48～§52；本地工程/受控锁定 Pi 自动化及安全相对目标投影复测通过，远端 Windows CI 曾失败，真实人工 TUI/Human Validation 仍 NOT_RUN） |
